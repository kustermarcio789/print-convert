...
const brandsData: Record<string, {
  ...
  creality: {
    ...
    products: [
      { id: '1', name: 'PEI Magnética Ender 3', category: 'PEI', price: 'R$ 89,90', oldPrice: 'R$ 119,90', rating: 4.8, reviews: 32, badge: 'Mais vendido' },
      { id: '2', name: 'Hotend All Metal CR-10', category: 'Hotends', price: 'R$ 149,90', rating: 4.9, reviews: 18 },
      { id: '3', name: 'Kit Correias GT2 6mm', category: 'Correias', price: 'R$ 29,90', rating: 4.7, reviews: 45 },
      { id: '4', name: 'Motor Nema 17 42-40', category: 'Motores', price: 'R$ 59,90', rating: 4.6, reviews: 22 },
      { id: '5', name: 'Bico Hardened Steel 0.4mm', category: 'Bicos', price: 'R$ 39,90', rating: 4.9, reviews: 56, badge: 'Premium' },
