              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    ...
                    <Link to={`/produto/${product.id}`} className="bg-accent text-accent-foreground p-3 rounded-xl hover:bg-accent/90 shadow-lg shadow-accent/20 transition-all hover:-translate-y-1">
