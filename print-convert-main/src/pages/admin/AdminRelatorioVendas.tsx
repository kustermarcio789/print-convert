      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400 mt-2">Análise detalhada do faturamento e desempenho comercial</p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-[#161923] p-6 rounded-lg  border border-white/10">
            ...
            <h3 className="text-gray-400 text-sm font-medium">Faturamento Total</h3>
          ...
          <div className="bg-[#161923] p-6 rounded-lg  border border-white/10">
            ...
            <h3 className="text-gray-400 text-sm font-medium">Quantidade de Vendas</h3>
            <p className="text-2xl font-bold text-white mt-1">
          ...
          <div className="bg-[#161923] p-6 rounded-lg  border border-white/10">
            ...
            <h3 className="text-gray-400 text-sm font-medium">Ticket Médio</h3>
            <p className="text-2xl font-bold text-white mt-1">
          ...
          <div className="bg-[#161923] p-6 rounded-lg  border border-white/10">
            ...
            <h3 className="text-gray-400 text-sm font-medium">Meta do Mês</h3>
            <p className="text-2xl font-bold text-white mt-1">
            ...
            {vendasMensais.map((venda, index) => (
              <div key={index}>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-gray-300">{venda.mes}</span>
                  <div className="flex items-center gap-4">
                    <span className="text-sm text-gray-400">{venda.quantidade} vendas</span>
              ...
              {vendasPorCategoria.length > 0 ? (
                vendasPorCategoria.map((cat, index) => (
                  <div key={index} className="border-b border-white/5 pb-4 last:border-0">
                    <div className="flex items-center justify-between mb-2">
                      <span className="font-medium text-white">{cat.categoria}</span>
        ...
        <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg border border-green-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-[#161923] p-4 rounded-lg">
              <h3 className="font-semibold text-white mb-2">Desempenho Geral</h3>
              <p className="text-sm text-gray-400">
            ...
            <div className="bg-[#161923] p-4 rounded-lg">
              <h3 className="font-semibold text-white mb-2">Tendência de Crescimento</h3>
              <p className="text-sm text-gray-400">
            ...
            <div className="bg-[#161923] p-4 rounded-lg">
              <h3 className="font-semibold text-white mb-2">Ticket Médio</h3>
              <p className="text-sm text-gray-400">
            ...
            <div className="bg-[#161923] p-4 rounded-lg">
              <h3 className="font-semibold text-white mb-2">Oportunidades</h3>
              <p className="text-sm text-gray-400">
                {vendasPorCategoria.length > 0 && (
