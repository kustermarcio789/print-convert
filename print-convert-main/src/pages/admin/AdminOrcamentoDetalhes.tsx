          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                {orcamento.detalhes.material && (
                  <div>
                    ...
                    <p className="text-white">{orcamento.detalhes.material}</p>
                  </div>
                )}
                {orcamento.detalhes.cor && (
                  <div>
                    <label className="text-sm font-medium text-gray-300">Cor</label>
                    <p className="text-white">{orcamento.detalhes.cor}</p>
                  </div>
                )}
                {orcamento.detalhes.quantidade && (
                  <div>
                    <label className="text-sm font-medium text-gray-300">Quantidade</label>
                    <p className="text-white">{orcamento.detalhes.quantidade}</p>
                  </div>
                )}
                {orcamento.detalhes.infill && (
                  <div>
                    <label className="text-sm font-medium text-gray-300">Preenchimento</label>
                    <p className="text-white">{orcamento.detalhes.infill}</p>
                  </div>
                )}
              </div>
              ...
              {orcamento.detalhes.arquivo && (
                <div className="mt-6">
                  <label className="text-sm font-medium text-gray-300 mb-2 block">Arquivo 3D</label>
                  <div className="flex items-center gap-4">
