      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400 mt-2">KPIs e métricas estratégicas em tempo real</p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {kpis.map((kpi, index) => {
            ...
            return (
              <div key={index} className={`bg-[#161923] p-6 rounded-lg  border ${cores.border}`}>
                ...
                <h3 className="text-gray-400 text-sm font-medium">{kpi.titulo}</h3>
                <p className="text-2xl font-bold text-white mt-1">{kpi.valor}</p>
                <div className="mt-4">
            ...
            {projecoes.map((proj, index) => (
              <div key={index} className="bg-gradient-to-br from-blue-50 to-purple-50 p-6 rounded-lg border border-blue-200">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="font-bold text-white">{proj.periodo}</h3>
                </div>
                <div className="space-y-3">
                  <div>
                    <p className="text-xs text-gray-400">Vendas Projetadas</p>
                    <p className="text-lg font-bold text-white">
                      R$ {proj.vendas.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                    </p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-400">Produção Estimada</p>
                    <p className="text-lg font-bold text-white">
                      {Math.round(proj.producao)} peças
                    </p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-400">Lucro Previsto</p>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-white">Crescimento</span>
                </div>
              ...
              <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-white">Margem de Lucro</span>
                </div>
              ...
              <div className="flex items-center justify-between p-4 bg-purple-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-white">Taxa de Conversão</span>
                </div>
              ...
              <div className="flex items-center justify-between p-4 bg-orange-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-white">Produtividade</span>
                </div>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-white">Expansão de Capacidade</h3>
              ...
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-white">Otimização de Preços</h3>
                    <p className="text-sm text-gray-400 mt-1">
              ...
              <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-white">Fidelização de Clientes</h3>
                    <p className="text-sm text-gray-400 mt-1">
              ...
              <div className="p-4 bg-orange-50 border border-orange-200 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-white">Gestão de Estoque</h3>
                    <p className="text-sm text-gray-400 mt-1">
