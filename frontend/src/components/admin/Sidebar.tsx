...
export const menuItems = [
  ...
  { id: 'impressoras', label: 'Impressoras', icon: Printer, path: '/admin/impressoras', color: 'text-cyan-400', bg: 'bg-cyan-500/20', section: 'cadastros' },
  { id: 'estoque', label: 'Estoque', icon: Layers, path: '/admin/estoque', color: 'text-amber-400', bg: 'bg-amber-500/20', section: 'cadastros' },
  
  // Vendas
  { id: 'orcamentos', label: 'Orçamentos', icon: ClipboardList, path: '/admin/orcamentos', color: 'text-purple-400', bg: 'bg-purple-500/20', section: 'vendas' },
  { id: 'pedidos', label: 'Pedidos', icon: ShoppingBag, path: '/admin/pedidos', color: 'text-orange-400', bg: 'bg-orange-500/20', section: 'vendas' },
  { id: 'vendas', label: 'Vendas', icon: ShoppingCart, path: '/admin/vendas', color: 'text-emerald-400', bg: 'bg-emerald-500/20', section: 'vendas' },
  
  // Produção
  { id: 'producao', label: 'Produção', icon: Factory, path: '/admin/producao', color: 'text-indigo-400', bg: 'bg-indigo-500/20', section: 'producao' },
